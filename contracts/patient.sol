...
contract Patient {
    ...
    mapping(uint256 =>attendant) attendantlist;
     ...
     address owner;
      ...
      constructor()  public {
          ...
          owner = 0xEAdFE508568E70c673aF6B4D11877A0B127CA563;
      }
     ...
     * */
     ...
     return (p1.patient_name,p1.age,p1.gender,p1.height,p1.weight,p1.patient_address,p1.phone_no,p1.email_id,p1.date);
     ...
     * */
     function retreive_attendant_details(uint256 patient_id) public view returns (string memory,string memory,uint256){
          ...
          attendant memory a1 = attendantlist[patient_id];
          
      return (a1.attendant_name,a1.attendant_relation,a1.attendant_phn_no);
