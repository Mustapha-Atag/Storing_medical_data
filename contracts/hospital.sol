...
contract Hospital  {
     ...
     * */
     function store_hospital_details(uint256 hospital_id,string memory _hospital_name,string memory _hospital_address,string memory _hospital_spec)public isOwner {
     ...
     * */
     ...
     hospital memory h1 = hospitallist[hospital_id];
